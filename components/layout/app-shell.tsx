...
export function AppShell({ children }: Props) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f5f5f6] text-black">
      <header className="sticky top-0 z-50 bg-[#f5f5f6] px-5 pt-5 sm:px-8">
        <div className="mx-auto flex h-12 w-full max-w-[1540px] items-center justify-between rounded-2xl bg-[#ececee] px-4 shadow-[0_1px_0_rgba(0,0,0,0.06)]">
          ...
          <Sheet>
            ...
            <SheetContent className="border-black/10 bg-[#f5f5f6] text-black">
                  ...
                  {links.map((link) =>
                    link.external ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="block rounded-xl border border-black/10 px-4 py-3 text-sm text-black/80 transition hover:bg-black/5"
                      >
                        {link.label}
                      </a>
                    ) : (
                      <Link
                        ...
                        className={cn(
                          ...
                          pathname === link.href
                            ? "border-[#ff2338]/60 bg-[#ff2338]/10 text-[#a01223]"
