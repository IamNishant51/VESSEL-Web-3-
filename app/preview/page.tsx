...
export default function PreviewPage() {
    return (
      <>
        ...
        <div className="min-h-screen overflow-x-clip bg-[#fafafa] px-3 pb-6 pt-12 text-[#171819] sm:px-4 sm:pb-8 sm:pt-16">
       <div className="mx-auto w-full max-w-[1280px] px-2 sm:px-4">
         <section className="mb-4 grid gap-2.5 rounded-[6px] border border-black/10 bg-white p-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] sm:grid-cols-[1.2fr_0.8fr] sm:gap-3 sm:p-3 lg:p-4">
           <div>
             <p className="text-[10px] font-semibold tracking-[0.18em] text-black/45">PREVIEW GALLERY</p>
             <h1 className="mt-2 max-w-3xl text-[20px] font-semibold leading-[0.98] tracking-[-0.03em] text-[#1d1f21] sm:mt-3 sm:text-[28px] lg:text-[40px]">
               Compare the full cNFT visual set before you mint.
             </h1>
             <p className="mt-2 max-w-2xl text-[12px] leading-[1.55] text-black/65 sm:mt-3 sm:text-[14px]">
            ...
            <div className="mt-4 flex flex-wrap gap-2.5 sm:mt-5 sm:gap-3">
              <Link href="/forge" className="btn-press btn-cta inline-flex min-h-[44px] items-center justify-center rounded-[4px] bg-[#171819] px-4 text-[11px] font-semibold tracking-[0.08em] text-white transition-colors hover:bg-[#111111] sm:h-10 sm:px-5 sm:text-[12px]">
                OPEN FORGE
              </Link>
              <Link href="/marketplace" className="btn-press btn-secondary inline-flex min-h-[44px] items-center justify-center rounded-[4px] border border-black/10 bg-white px-4 text-[11px] font-semibold tracking-[0.08em] text-black/70 transition-colors hover:bg-black/5 sm:h-10 sm:px-5 sm:text-[12px]">
                VIEW MARKETPLACE
              </Link>
            </div>
           </div>
           ...
           <div className="grid gap-2.5 sm:grid-cols-2 sm:gap-3">
             <div className="rounded-[4px] border border-black/10 bg-[#f6f7f8] p-3 sm:p-4">
               ...
               <p className="mt-1.5 text-[14px] font-semibold tracking-[-0.02em] text-[#1d1f21] sm:mt-2 sm:text-[16px]">One agent, one visual identity.</p>
             ...
             <div className="rounded-[4px] border border-black/10 bg-[#f6f7f8] p-3 sm:p-4">
               ...
               <p className="mt-1.5 text-[14px] font-semibold tracking-[-0.02em] text-[#1d1f21] sm:mt-2 sm:text-[16px]">Animated SVG overlays.</p>
           ...
           {previewAgents.map((agent) => (
             <article key={agent.id} className="overflow-hidden rounded-[6px] border border-black/10 bg-white shadow-[0_1px_4px_rgba(0,0,0,0.04)] transition-shadow hover:shadow-md">
               <div className="relative aspect-[4/5] overflow-hidden bg-[#0b0f16]">
                 ...
                 <div className="absolute left-2 top-2 rounded-[2px] bg-[#171819] px-2 py-1 text-[10px] font-semibold tracking-[0.12em] text-white/80 sm:left-2.5 sm:top-2.5 sm:text-[11px]">
                 ...
                 <div className="absolute bottom-2 left-2 right-2 flex items-end justify-between gap-2 sm:bottom-2.5 sm:left-2.5 sm:right-2.5">
                   <div className="min-w-0">
                     <p className="text-[10px] font-semibold tracking-[0.15em] text-white/40 sm:text-[11px]">SEED {agent.seed}</p>
                     <h2 className="mt-0.5 truncate text-[13px] font-semibold tracking-[-0.02em] text-white sm:text-[16px]">{agent.name}</h2>
                   </div>
                   <span className="shrink-0 rounded-[2px] bg-[#e7f3f2] px-1.5 py-1 text-[10px] font-semibold tracking-[0.12em] text-[#171819] sm:text-[11px]">
               ...
               <div className="space-y-2 p-2.5 sm:space-y-3 sm:p-3">
                 ...
                 <div className="flex flex-wrap gap-1">
                   {agent.tools.slice(0, 3).map((tool) => (
                     <span key={tool} className="rounded-[2px] bg-black/[0.04] px-1.5 py-1 text-[10px] font-medium tracking-[0.08em] text-black/60 sm:text-[11px]">
                       {tool}
                     </span>
                   ))}
                 </div>
